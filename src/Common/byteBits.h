  ...
  union byteBits
  {
    ...
    public:
      ...
      void setBitValue(uint8_t index, bool value) volatile
      {
        switch(index)
        {
          case 0: bits.b0 = value; break;
          case 1: bits.b1 = value; break;
          case 2: bits.b2 = value; break;
          case 3: bits.b3 = value; break;
          case 4: bits.b4 = value; break;
          case 5: bits.b5 = value; break;
          case 6: bits.b6 = value; break;
          case 7: bits.b7 = value; break;
          default: return;
        }
      }
  };
